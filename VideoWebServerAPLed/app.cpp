...
const char index_web[] = 
    ...
    "        left: 20%;\n"
    "        top: 7vh;\n"
    "        background-color: rgba(81, 65, 200, 0.619);\n"
    "        padding: 50px;\n"
    "        width: 100px;\n"
    "        border: 10px black;\n"
    "        border-style: double;\n"
    ...
    "    <div>\n"
    "      <h2>SWITCH</h2>\n"
    "      <p><button type='button' id='on'><h2>on</h2></button></p>\n"
    "      <p><button type='button' id='off'><h2>off</h2></button></p>\n"
    "      <h2><p id='led'></p></h2>\n"
    "    </div>\n"
    "  </body>\n"
    "  <script>\n"
